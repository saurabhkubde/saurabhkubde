...
import VSRXSILHOUETTEPART1 from '@salesforce/label/c.B2B_EE_VS_RX_PART1';
import VSRXSILHOUETTEPART2 from '@salesforce/label/c.B2B_EE_VS_RX_PART2';
...
export default class B2b_vsRxSilhouette extends LightningElement {
    label = {
        eE1: VSRXSILHOUETTEPART1,
        eE2: VSRXSILHOUETTEPART2,
