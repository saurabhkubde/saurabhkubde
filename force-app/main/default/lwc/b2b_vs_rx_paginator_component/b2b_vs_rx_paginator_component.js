 ...
 */
export default class B2b_vs_rx_paginator_component extends LightningElement {
    get label() {
        return {
    ...
    jumpPage(event) {
        this.dispatchEvent(new CustomEvent(EVENTS.PAGE_JUMP, { detail: Number(event.target.innerText) }));
