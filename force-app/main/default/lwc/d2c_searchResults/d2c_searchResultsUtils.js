const variationAttributeLabel = '{name}: {value}';
...
/**
 * @typedef {import('../d2c_searchProductGrid/d2c_searchProductGrid').BuilderFieldItem} BuilderFieldItem
 */
...
export function computeConfiguration(configParameters) {
    const { layout = '', gridMaxColumnsDisplayed = 4, addToCartDisabled = false, builderCardConfiguration } = configParameters || {};
    const {
        addToCartButtonText = '',
